...
* [`src/cljs/kehys/`](src/cljs/kehys/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/kehys/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `kehys` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/kehys/config.cljs) defaults to `true` in
...
```clj
(ns kehys.example
  (:require [kehys.config :as config])
